...
## Terms of use
The code is licensed under [GPLv3](http://www.gnu.org/licenses/gpl-3.0.html). Copyright (C) 2013 Ajasja Ljubetič. In published work which uses this package please cite [Ljubetič et al, J. Chem. Phys. 140, 084109 (2014)](http://dx.doi.org/10.1063/1.4866448).
